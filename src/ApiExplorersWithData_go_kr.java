// refer source : https://fbtmdwhd33.tistory.com/264
// api : 외교부_국가·지역별 최신 안전소식(코로나 관련) 데이터(from https://www.data.go.kr/)
...
public class ApiExplorersWithData_go_kr {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=BoygPZjC27pxm92hSposjnSob2u36vziS1rzIzxkrL9QxmlhB0SMARwLfNlBE3wrE7nnw34zLmmv0a6amvW4xg=="); /*Service Key*/
